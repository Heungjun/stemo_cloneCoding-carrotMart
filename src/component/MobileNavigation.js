...
const MobileNavigation = ({ currentIndex, onClick }) => {
  return (
    <nav className="mobile-navigation">
      <ul className="mobile-navigation__navigator">
        <li className="mobile-navigation__item" onClick={() => onClick(0)}>
          <img
        ...
        <li className="mobile-navigation__item" onClick={() => onClick(1)}>
          <img
            className="mobile-navigation__item-icon"
        ...
        <li className="mobile-navigation__item" onClick={() => onClick(2)}>
          <img
            className="mobile-navigation__item-icon"
        ...
        <li className="mobile-navigation__item" onClick={() => onClick(3)}>
          <img
            className="mobile-navigation__item-icon"
        ...
        <li className="mobile-navigation__item" onClick={() => onClick(4)}>
          <img
            className="mobile-navigation__item-icon"
